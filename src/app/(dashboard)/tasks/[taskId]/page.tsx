...
export default function TaskDetailPage() {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden">
      <div className="flex-shrink-0 border-b border-white/[0.06] bg-white/[0.01] backdrop-blur-sm">
          ...
          <div className="flex gap-8">
            <div className="flex-1 min-w-0 space-y-8">
              <div>
                ...
                {task.description && (
                  <div className="rounded-[12px] bg-white/[0.02] border border-white/[0.06] p-4">
            ...
            <div className="w-64 flex-shrink-0 space-y-6">
              <div className="rounded-[14px] bg-white/[0.02] border border-white/[0.06] p-4 space-y-5">
              ...
              {task.subtasks && task.subtasks.length > 0 && (
                <div className="rounded-[14px] bg-white/[0.02] border border-white/[0.06] p-4">
