    ...
    return (
      <CyberBackgroundEffect>
        <div className="min-h-screen relative z-10 flex items-center justify-center p-4">
          <div className="w-full max-w-md p-8 bg-white/[0.03] backdrop-blur-[30px] rounded-[16px] border border-white/[0.08] shadow-[0_12px_48px_rgba(0,0,0,0.3)] relative overflow-hidden before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-gradient-to-r before:from-transparent before:via-white/[0.12] before:to-transparent">
