...
export function TaskCard({ task, onClick, onDelete, isDragging, readOnly }: TaskCardProps) {
  ...
  return (
    <div
      ...
      {...listeners}
      className={cn(
        'group bg-white rounded-lg border border-gray-200 p-3 cursor-grab active:cursor-grabbing transition-all duration-200 relative',
      ...
      <div className="flex items-start gap-2">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2">
            <h4 
              className="text-sm font-medium text-gray-900 line-clamp-2 flex-1 cursor-pointer"
              onClick={(e) => {
                e.stopPropagation()
                onClick?.()
              }}
